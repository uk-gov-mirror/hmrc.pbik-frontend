...
AddBenefitsMPBIK2.Heading.agent = Choose which benefits to tax through your client''s payroll

AddBenefitsMPBIK2.selectAll = Dewiswch bob un sy’n gymwys

AddBenefitsMPBIK2.noselection.error = You must select at least one benefit
