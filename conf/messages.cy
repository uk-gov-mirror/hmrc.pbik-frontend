...
PayrollingSummaryMPBIK2.tab.taxYear = Blwyddyn dreth Ebrill {0} i {1}
...
PayrollingSummaryMPBIK2.you.can = Gallwch chi
PayrollingSummaryMPBIK2.choose.benefit.link.text = ddefnyddio’r gwasanaeth hwn i gofrestru a chadw trefn ar y buddiannau sy’n cael eu trethu drwy gyflogres [Client name].
...
PayrollingSummaryMPBIK2.benefits.text.agent = These are the benefits that you have registered to tax through your client''s payroll from 6 April {0}.
...
ExclusionOverviewMPBIK.benefitsManage.inset = Ni allwch ailddechrau talu drwy’r gyflogres yn y flwyddyn dreth bresennol ar gyfer cyflogeion sydd wedi’u heithrio.
